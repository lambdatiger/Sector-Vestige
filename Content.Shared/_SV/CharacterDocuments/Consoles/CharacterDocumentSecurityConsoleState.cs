...
public sealed class CharacterDocumentSecurityConsoleState : BoundUserInterfaceState
{
    ...
    public CharacterDocumentSecurityConsoleState(Dictionary<NetEntity, string> playerlist, NetEntity? selectedplayer,
